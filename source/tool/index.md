...
<meta charset="utf-8">
    ...
    <meta name="author" content="viggo &amp; nikoyu">
    <title>百宝箱丨Niko Yu BLOG</title>
    <meta name="keywords" content="www.nikoyu.asia,nikoyu,百宝箱,在线工具箱,素材资源网站,网站导航">
    <meta name="description" content="WebStack - 收集国内外优秀资源网站，www.nikoyu.asia">
    ...
    <![endif]-->
<style seniversewidget="" data-styled-version="4.3.2"></style></head>
        ...
        <div class="main-content" style="">
            ...
            <nav class="navbar user-info-navbar" role="navigation">
                ...
                <ul class="user-info-menu left-links list-inline list-unstyled">
                    ...
                    <li style="min-height: 75px;">
                        <a href="/link/" target="_blank" style="padding: 30px 20px;">
                            <i class="fa fa-link"></i>
                            友情链接
                        </a>
                    </li>
                    <li style="min-height: 75px;">
                        <a href="/guestbook/" target="_blank" style="padding: 30px 20px;">
                    ...
                    <!-- 天气 -->
                    <li style="min-height: 75px;">
                        <a id="tp-weather-widget" style="padding: 28px 20px;"><div class="sc-csuQGl sw-container sc-eqIVtm fsIvwB"></div></a>
                        <script>
...
<h4 class="text-gray"><i class="linecons-tag" style="margin-right: 7px;" id="开发社区"></i>开发社区</h4>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/2048/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="网页版 2048 小游戏">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
                ...
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/cat/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="圈小猫小游戏，点击圆点围住小猫">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
                ...
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/element/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="3D 网页展示元素周期表">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
                ...
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/gobang/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="网页版简易五子棋">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/PacMan/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="躲避怪物，吃掉豆子">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
                ...
                <div class="col-sm-3">
                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.itrhx.com/games/piano/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="简易网页版钢琴">
                        <div class="xe-comment-entry">
                            <a class="xe-user-img">
            ...
            <footer class="main-footer sticky footer-type-1" style="">
                <div class="footer-inner">
                    ...
                    <div class="footer-text">
                        ...
                        <a href="https://github.com/WebStackPage/WebStackPage.github.io" target="_blank"><strong>WEBSTACK</strong></a> 丨 DESIGNED BY <a href="http://viggoz.com" target="_blank"><strong>VIGGO</strong></a> 丨 CHANGED BY <a href="https://nikoyu.asia" target="_blank"><strong>NikoYu</strong></a>
                    </div>
