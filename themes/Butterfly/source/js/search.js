...
document.writeln("							<ul class=\'search-type\'>");
//爱奇艺
document.writeln("<li><input hidden type=\'radio\'name=\'type\'id=\'type-aiqiyi\'value=\'https://so.iqiyi.com/so/q_\'data-placeholder=\'爱奇艺\'><label for=\'type-aiqiyi\'><span style=\'color:#003daa\'>爱奇艺</span></label></li>");
document.writeln("							   ");
//腾讯视频
document.writeln("<li><input hidden type=\'radio\'name=\'type\'id=\'type-qq\'value=\'https://v.qq.com/x/search/?q=\'data-placeholder=\'腾讯视频\'><label for=\'type-qq\'><span style=\'color:#003daa\'>腾讯视频</span></label></li>");
document.writeln("							   ");
